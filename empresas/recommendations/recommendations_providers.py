...
# Respuestas recomendaciones proveeedores
    ...
    def respuesta_providers_ventas_interpretation(self):
        if self.id==1610:
            ...
            balance_sells_deviation = float(self.balance_providers_sells()[len(self.balance_providers_sells())-1]['c']-self.balance_providers_sells_avg_sector()[len(self.balance_providers_sells_avg_sector())-1]['c'])/abs(float(self.balance_providers_sells_avg_sector()[len(self.balance_providers_sells_avg_sector())-1]['c']))
    ...
    def respuesta_providers_ventas_interpretation_delta(self):
        if len(self.balance_providers_sells())>1:
            balance_providers_sells_delta = float(self.balance_providers_sells()[len(self.balance_providers_sells())-1]['c']-self.balance_providers_sells()[len(self.balance_providers_sells())-2]['c'])/abs(float(self.balance_providers_sells()[len(self.balance_providers_sells())-2]['c']))
            balance_providers_sells_avg_sector_delta = float(self.balance_providers_sells_avg_sector()[len(self.balance_providers_sells_avg_sector())-1]['c']-self.balance_providers_sells_avg_sector()[len(self.balance_providers_sells_avg_sector())-2]['c'])/abs(float(self.balance_providers_sells_avg_sector()[len(self.balance_providers_sells_avg_sector())-2]['c']))
...
# Como son mis  clientes? - EBITDA
    ...
    def respuesta_providers_ebitda_interpretation_delta(self):
        if len(self.balance_providers_ebitda())>1:
            balance_providers_ebitda_delta = float(self.balance_providers_ebitda()[len(self.balance_providers_ebitda())-1]['c']-self.balance_providers_ebitda()[len(self.balance_providers_ebitda())-2]['c'])/abs(float(self.balance_providers_ebitda()[len(self.balance_providers_ebitda())-2]['c']))
            balance_providers_ebitda_avg_sector_delta = float(self.balance_providers_ebitda_avg_sector()[len(self.balance_providers_ebitda_avg_sector())-1]['c']-self.balance_providers_ebitda_avg_sector()[len(self.balance_providers_ebitda_avg_sector())-2]['c'])/abs(float(self.balance_providers_ebitda_avg_sector()[len(self.balance_providers_ebitda_avg_sector())-2]['c']))
...
# Como son mis  clientes? - REsultado de explotacion
    ...
    def respuesta_providers_resultado_interpretation_delta(self):
        if len(self.balance_providers_resultado())>1:
            balance_providers_resultado_delta = float(self.balance_providers_resultado()[len(self.balance_providers_resultado())-1]['c']-self.balance_providers_resultado()[len(self.balance_providers_resultado())-2]['c'])/abs(float(self.balance_providers_resultado()[len(self.balance_providers_resultado())-2]['c']))
            balance_providers_resultado_avg_sector_delta = float(self.balance_providers_resultado_avg_sector()[len(self.balance_providers_resultado_avg_sector())-1]['c']-self.balance_providers_resultado_avg_sector()[len(self.balance_providers_resultado_avg_sector())-2]['c'])/abs(float(self.balance_providers_resultado_avg_sector()[len(self.balance_providers_resultado_avg_sector())-2]['c']))
    ...
    #     monthly_buys_deviation = float(self.get_monthly_sells()[len(self.get_monthly_sells())-1]['c']-self.get_monthly_sector_avg_sells())[len(self.get_monthly_sector_avg_sells())-1]['c'])/abs(float(self.get_monthly_sector_avg_sells()[len(self.get_monthly_sector_avg_sells())-1]['c']))
...
# Como me relaciono con ellos? - Frecuencia
    ...
    def respuesta_providers_frecuencia_interpretation(self):
        ...
        hhi_temporal_providers_deviation = float(self.hhi_temporal_providers()-self.hhi_temporal_sector_providers())/abs(float(self.hhi_temporal_sector_providers()))
...
# Como me relaciono con ellos? - Penetración
    ...
    def respuesta_providers_penetracion_interpretation(self):
        if len(self.balance_providers_ebitda())>0:
            ...
            my_penetration_providers_deviation = float(self.my_penetration_provider()-self.my_sector_penetration_provider())/abs(float(self.my_sector_penetration_provider()))
...
# Debería buscar nuevas ooportunidades? - Índices de concentración
    ...
    def respuesta_providers_concentracion_interpretation(self):
        ...
        hhi_geografical_providers_deviation = float(self.hhi_geografical_providers()-self.hhi_geografical_sector_providers())/abs(float(self.hhi_geografical_sector_providers()))
        hhi_cnae_providers_deviation = float(self.hhi_cnae_providers()-self.hhi_cnae_sector_providers())/abs(float(self.hhi_cnae_sector_providers()))
        hhi_temporal_providers_deviation = float(self.hhi_temporal_providers()-self.hhi_temporal_sector_providers())/abs(float(self.hhi_temporal_sector_providers()))
...
# Como podria hacerlo ? - Margen de venta y/o ratio de eficiencia / ticket medio
    ...
    def respuesta_providers_margen_interpretation(self):
        if len(self.balance_providers_ebitda())>0:
            margen_comercial_providers_deviation = float(self.margen_comercial_providers()-self.margen_comercial_sector_providers())/abs(float(self.margen_comercial_sector_providers()))
